...
public sealed class LayoutAndPageRenderTests : BunitContext
{
    ...
    public void HomePage_RendersThreeColumnHomepageWithServiceBackedSidebars()
    {
        ...
        Assert.True(cut.Find(".home-carousel__caption-track").HasAttribute("hidden"));
        Assert.Single(cut.FindAll(".home-carousel__caption-panel.is-active"));
        Assert.Contains("Show caption", cut.Markup, StringComparison.OrdinalIgnoreCase);
    ...
    private sealed class FakeEventManagementService : IEventManagementService, IEventOperationLogSink
    {
        ...
        [
            new(
                ...
                Anchor.Domain.Events.EventRecurrencePattern.MonthlyNthWeekday,
                1,
                DayOfWeek.Friday,
                Anchor.Domain.Events.EventRecurrenceWeek.Third,
                null,
            ...
            new(
                ...
                Anchor.Domain.Events.EventRecurrencePattern.Weekly,
                2,
                DayOfWeek.Friday,
                null,
