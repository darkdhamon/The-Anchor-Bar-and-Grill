...
- Homepage photo carousel now keeps a fixed widescreen frame, uses contained placeholder-image scaling so venue photos stay fully visible without crop, floats into a half-width wrap layout beside the welcome copy on larger screens, stacks first ahead of the text once the screen narrows, auto-rotates every ten seconds, and pauses while hovered or touched
