...
- Homepage photo carousel now keeps a fixed widescreen frame, uses contained placeholder-image scaling so venue photos stay fully visible without crop, lets the welcome headline lead while the carousel sits higher beside the copy on larger screens, includes a simple show/hide caption link, stacks the carousel first ahead of the content once the screen narrows, auto-rotates every ten seconds, and pauses while hovered or touched
