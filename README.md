...
- The shared header now uses a lower-profile brand row with one larger overhanging logo carrying the restaurant name through its image alt text, no duplicate visible site-name text, tightened navigation and account controls, added top-page clearance so content starts below the logo, and a compact theme toggle
