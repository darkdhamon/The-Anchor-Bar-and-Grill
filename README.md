...
- Database-backed Menu Editor with a left-side workspace rail for dedicated `Food`, `Drinks`, and `Hours` views, plus section-tree browsing, item-backed special offers, parent/child sections, chip-style visibility and scheduling controls, section callouts, archive-aware filters, content filters, duplicate-name protection, and service-hour management
