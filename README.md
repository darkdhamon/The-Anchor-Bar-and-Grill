...
- Public menu hours now collapse repeated daily schedules into grouped ranges such as `Daily`, `Monday-Friday`, or `Sunday-Thursday`, and the row that includes today is marked inline instead of repeating a separate today's-hours callout
