...
- The menu-item description field now accepts both live keystrokes and committed text-entry events, so Windows voice dictation and similar accessibility input tools can populate it reliably
