...
- Homepage photo carousel now keeps a fixed widescreen frame and uses contained placeholder-image scaling so venue photos stay fully visible without crop while the gallery-backed version is still pending
