...
- The public menu now uses a left sidebar for service selection, keeps weekly hours focused on the active menu only, and opens menu categories as accordion sections with the first category expanded by default
