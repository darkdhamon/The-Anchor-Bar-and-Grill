...
- The Hours workspace now opens with a denser summary board so all four grouped service schedules can be compared without wasted space, and staff can click any summary card to jump straight into editing that service
